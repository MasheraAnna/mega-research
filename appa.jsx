		...
		render: function(){
			return(
				<div>
					...
					можно будет дальше пойти, т.к. question принимает респ-ид как обязательное условие 
					-переписать еще нумерацию вопросов не по id, а по индексу </p>
					<p> {this.state.data} </p>
					<p> {this.props.data['question']['id']} </p>
					<p> {this.props.data['question']['qText']} </p>
